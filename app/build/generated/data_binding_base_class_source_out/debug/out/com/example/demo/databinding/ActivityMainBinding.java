...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull SeekBar seekBar,
      @NonNull TextView textView, @NonNull TextView textViewValue, @NonNull TextView title) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, seekBar, textView, textViewValue,
          title);
    }
